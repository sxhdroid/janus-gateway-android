 ...
 * Rk3399 下支持H264编码
 */
public class RkHardwareVideoEncoderFactory implements VideoEncoderFactory {
    private static final String TAG = "RkHardwareVideoEncoderFactory";
    ...
    private static final String QCOM_RK_PREFIX = "OMX.rk.";
     ...
     */
    public RkHardwareVideoEncoderFactory(
     ...
     */
    public RkHardwareVideoEncoderFactory(EglBase.Context sharedContext, boolean enableIntelVp8Encoder,
    ...
    @Deprecated
    public RkHardwareVideoEncoderFactory(boolean enableIntelVp8Encoder, boolean enableH264HighProfile) {
    ...
    private boolean isHardwareSupportedInCurrentSdkH264(MediaCodecInfo info) {
        ...
        return (name.startsWith(QCOM_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
                // RK3399 H264 encoder
                || (name.startsWith(QCOM_RK_PREFIX) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
